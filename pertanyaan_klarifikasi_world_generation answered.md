...
# Keputusan yang sudah dipahami dan tidak perlu dijawab ulang (ada yang dikoreksi)
...
fitur tambahan: world generation memerlukan buffer waktu sebelum membolehkan player spawn supaya semuanya generate dengan lancar, jadi saat proses generation saya ingin ada progress bagian mana saja yang sedang dibuat. jika debug mode aktif, saya ingin semuanya diberi timer saat generation dan laporan pada menu baru yaitu world gen log di menu timer, tambahkan juga debug menu untuk memberi tau section mana saja yang sedang aktif (dilakukan dengan text pada hud player)

layer 0/hub utama hanya ada 1