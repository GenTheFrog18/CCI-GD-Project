...
func _test_room_loads() -> void:
	...
	room.free()
	var debug_room := preload("res://game/world/foundation_debug_room.tscn").instantiate()
	assert(debug_room.get_node("Platform") != null)
	assert(debug_room.get_node("RockPickup") != null)
	assert(debug_room.get_node("BreakableLoot") != null)
	assert(debug_room.get_node("RopeAnchor") != null)
	assert(debug_room.get_node("TestAmphibian") != null)
	assert(debug_room.get_node("ProjectileTurret") != null)
	assert(debug_room.get_node("TestShopTerminal") != null)
	debug_room.free()
